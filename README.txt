...
Enhance WordPress comments with the TinyMCE Editor, Inline Comment Editing and Asynchronous Posting. (Longer description here)

== Installation ==

1. Upload `` to the `/wp-content/plugins/` directory
1. Activate the plugin through the "Plugins" menu in WordPress
1. Place `<?php do_action("tinymce-comments-plus_hook"); ?>` in your templates
