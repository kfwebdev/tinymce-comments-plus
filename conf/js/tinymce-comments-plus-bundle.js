...
/******/ 	var hotCurrentHash = "4417dde77ccddb877272"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function ($) {
		...
		tcp.EditView = Backbone.View.extend({
			...
			template: _.template('<textarea id="tcpCommentEditor<%= commentId %>" rows="8"><%= content %></textarea>' + '<div class="reply tcp-reply-container"><span class="spinner" style="display:none;"></span><a href="javascript:void(0);" class="' + tcpGlobals.cssButton + ' ' + tcpGlobals.cssSubmitEditButton + '">Submit</a> ' + '<a href="javascript:void(0);" class="' + tcpGlobals.cssButton + ' ' + tcpGlobals.cssCancelEditButton + '">Cancel</a></div>'),
		...
		tcp.RespondView = Backbone.View.extend({
			...
			resetEditors: function resetEditors() {
				tcp.resetEditors();
			},
			...
			submitForm: function submitForm(event) {
				...
				$.ajax({
					...
					var $commentData = $(data).find(tcpGlobals.commentsList),
		...
		tcp.CommentsView = Backbone.View.extend({
			...
			editComment: function editComment(event) {
				...
				if ($editLink.length && parseInt(postId) > 0 && parseInt(commentId) > 0) {
	...
	_react2['default'].render(_react2['default'].createElement(Comments, null), document.getElementById('root'));

	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(171); if (makeExportsHot(module, __webpack_require__(69))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "tinymce-comments-plus.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
